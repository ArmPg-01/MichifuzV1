...
const handler = async (m, { conn, args, command, usedPrefix }) => {
  ...
  *Reglas CLK*
✅ Instrucciones
La primera ronda se juega a Desert Eagle. No obstante, a partir de la segunda ronda la Desert queda prohibida.
De la segunda ronda en adelante se juega con UMP y M1014 (solo se permiten UNA M1014 por equipo; la UMP no tiene restricciones).
Se permite dejar presionada la M1014.
Unicas Habilidades ALOK, MOCO, KELLY MAXIM.
❌ Prohibiciones
Se prohíbe la Desert Eagle a partir de la segunda ronda.
Se prohíbe tener más de dos M1014 por equipo.
Se prohíben los segundos pisos.
Se prohíbe encerrarse en paredes de hielo.
⚙️ Configuración De La Sala De Compe
Duelo De Escuadras, 13 Rondas, 200 De Vida, 9500 Monedas, Municiones Limitadas, Tienda Avanzada.
`;
